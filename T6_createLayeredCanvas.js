...
function renderBackground_T6(){
	...
	T6.contextbackground.fillStyle='#090909';
...
function renderForeground_T6(){
    ...
    T6.contextforeground.fillStyle = 'MidnightBlue';
    T6.contextforeground.fill();
    T6.contextforeground.closePath();	
    ...
    T6.contextforeground.fillStyle = "dimgrey";
    ...
    T6.contextforeground.textAlign = "left";
    T6.contextforeground.fillStyle = "dimgrey";
    T6.contextforeground.fillText("GREGORIAN DATE = "+T6.YEAR+"."+T6.MONTH+"."+T6.DAY,10,T6.height-20);	
}
